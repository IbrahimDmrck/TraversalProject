...
namespace TraversalProject.Areas.Member.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> MyCurrentReservation()
        {
            ...
            var ApprovalReservation = _reservationManager.GetListWithReservationByAccepted(values.Id);
        ...
        {
            var values = await _userManager.FindByNameAsync(User.Identity.Name);
            var ApprovalReservation = _reservationManager.GetListWithReservationByPrevious(values.Id);
            return View(ApprovalReservation);
        ...
        {
            var values = await _userManager.FindByNameAsync(User.Identity.Name);
            var ApprovalReservation = _reservationManager.GetListWithReservationByWaitApproval(values.Id);
            return View(ApprovalReservation);
